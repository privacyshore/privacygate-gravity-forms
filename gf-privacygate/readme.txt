...
Contributors: PrivacyGate
Tags: payment processor, PrivacyGate, ethereum, litecoin, Gravity Forms bitcoin, bitcoin, cryptocurrency, payment gateway, Gravity Forms, Gravity Forms payment gateway, payment forms
Plugin URI:
...
PrivacyGate is the digital payment service that allows merchants to accept payments in a variety of digital currencies like Bitcoin, Bitcoin Cash, Ethereum and Litecoin. These payments are received directly into a merchant-controlled wallet.
...
4. Visit the **Plugins** menu in your WordPress dashboard, find `PrivacyGate Payments For Gravity Forms` in your plugin list, and click the Activate link.

5. Visit the **Forms->Settings** menu, select the PrivacyGate Tab, and add your API Key, Shared Secret Key from PrivacyGate Dashboard (https://dash.privacygate.io/settings).

6. Copy Webhook Notification Url from PrivacyGate Tab to Settings/Webhook subscription https://dash.privacygate.io/dashboard/settings

7. Create new Gravity form and add PrivacyGate Feed.
